Action()
{
	...
	web_submit_form("new",
		"Snapshot=t11.inf",
		ITEMDATA,
		"Name=firstName", "Value={firstNames}", ENDITEM,
		"Name=lastName", "Value={LastNames}", ENDITEM,
		"Name=address", "Value=Luk Yu Building, 24-26 Stanley Street, Central, Hong Kong", ENDITEM,
		"Name=city", "Value={Cities}", ENDITEM,
		"Name=telephone", "Value={PhoneNumbers}", ENDITEM,
		EXTRARES,
	...
	lr_start_transaction("findOneLastNameOwners");
	...
	web_submit_form("owners",
		"Snapshot=t13.inf",
		ITEMDATA,
		"Name=lastName", "Value={NewParam}", ENDITEM,
		LAST);
	lr_end_transaction("findOneLastNameOwners", LR_AUTO);

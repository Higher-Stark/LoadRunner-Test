Action()
{
	...
	lr_start_transaction("Add_owner_1");
	...
	lr_start_sub_transaction("Add_pet_1", "Add_owner_1");
	...
	lr_end_sub_transaction("Add_pet_1", LR_AUTO);

	lr_start_sub_transaction("add_pet_2", "Add_owner_1");
	...
	lr_end_sub_transaction("add_pet_2", LR_AUTO);

	lr_end_transaction("Add_owner_1", LR_AUTO);
	...
	lr_start_transaction("Add_owner_2");
	...
	lr_end_transaction("Add_owner_2", LR_AUTO);
	...
	lr_start_transaction("Add_pet_3");
	...
	lr_end_transaction("Add_pet_3", LR_AUTO);
